...
namespace MTNAutomationTests.TestCases.Master_Terminal.EDI_Functions
{
    ...
    public class TestCase40607 : MTNBase
    {

        EDIOperationsForm ediOperationsForm;
        protected static string ediFile1 = "M_40607_COPARN.edi";
        [ClassInitialize]
        ...
        [TestMethod]
        public void CoparnVoyageTranslation()
        {
            MTNInitialize();
            
            /*
            To test that if a voyage have Lloyds Number and Call Sign, the voyage translation finds the correct voyage to apply changes through EDI file.
            ...
            EDI file - used customer's edi file and edited the TDT+20 section to specify foreign code for voyage, Lloyd number of the voyage and vessel used in this test 
            */
            ...
            ediOperationsForm.DeleteEDIMessages(@"Gate Document", @"40607", @"Loaded");
            ...
            MTNControlBase.FindClickRowInTable(ediOperationsForm.tblEDIDetails, @"Voyage^BISL000001", clickType: ClickType.None, rowHeight: 16);
