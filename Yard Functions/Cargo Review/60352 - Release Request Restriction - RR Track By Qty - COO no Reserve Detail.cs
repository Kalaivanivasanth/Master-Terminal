...
namespace MTNAutomationTests.TestCases.Master_Terminal.Yard_Functions.Cargo_Review
{
    ...
    public class TestCase60352 : MTNBase
    {
        ...
        public void ReleaseRequestTrackedByQtyNoReserveDetailsWithCOO()
        {
            ...
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRoad, "60352Road1",
                ReleaseRequestAddForm.ReleaseType.Road);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestShip, "60352Ship1",
                ReleaseRequestAddForm.ReleaseType.Ship);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRail, "60352Rail1",
        ...
        void DoReleaseRequestProcess(string menuOptionToSelect, string releaseNo, string releaseType)
        {
            ...
            WarningErrorForm.CheckErrorMessagesExist("Errors for Release Request update TT1",
                new[]
                {
                    $"Code :96296. Item {_cargoGroupId[0]} has 200 Items in current ownership changes, cannot release further 500 Items"
                });
