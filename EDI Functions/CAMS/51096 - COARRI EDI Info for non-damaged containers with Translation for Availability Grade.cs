...
namespace MTNAutomationTests.TestCases.Master_Terminal.EDI_Functions.CAMS
{
    ...
    public class TestCase51096 : MTNBase
    {
        ...
        [TestMethod]
        public void COARRIEDIInfoForNonDamagedContainersWithTranslationForAvailabilityGrade()
        {
            MTNInitialize();
            ...
            roadGateDetailsReceiveForm.TxtCargoId.SetValue("JLG51096A01");
            ...
            roadGateDetailsReceiveForm.CmbOperator.SetValue(Operator.ACL,  doDownArrow: true);
            ...
            MTNControlBase.FindClickRowInTable(voyageOperationsForm.TblOnVessel,
                 @"ID^JLG51096A01~Location^MSKA2000001~Total Quantity^1~Cargo Type^ISO Container", ClickType.ContextClick, rowHeight: 16);
            /*voyageOperationsForm.tblOnVessel1.FindClickRow(
                new[] { "ID^JLG51096A01~Location^MSKA2000001~Total Quantity^1~Cargo Type^ISO Container" },
                ClickType.ContextClick);*/
            voyageOperationsForm.ContextMenuSelect(@"Tranship...");
            
            // Step 14 
            TranshipForm transhipForm = new TranshipForm(@"JLG51096A01 TT1");
            ...
            MTNControlBase.FindClickRowInTable(voyageOperationsForm.TblOnVessel,
                @"ID^JLG51096A01~Location^MSKA2000001~Total Quantity^1~Cargo Type^ISO Container~IMEX Status^Tranship",
                ClickType.None, rowHeight: 16);
            /*voyageOperationsForm.tblOnVessel1.FindClickRow(
                new[] { "ID^JLG51096A01~Location^MSKA2000001~Total Quantity^1~Cargo Type^ISO Container~IMEX Status^Tranship" }, 
                    ClickType.None);*/
            ...
            MTNControlBase.SetValueInEditTable(cargoEnquiryForm.tblSearchCriteria, @"Cargo ID", @"JLG51096A01");
            ...
            _cargoEnquiryTransactionForm = new CargoEnquiryTransactionForm(formTitle:
                "Transactions for JLG51096A01 (Tranship Outbound) TT1");
            ...
            loggingDetailsForm.FindStringInTable(@"FTX+DAR++4:ZZZ:184+NOT DAMAGED");
