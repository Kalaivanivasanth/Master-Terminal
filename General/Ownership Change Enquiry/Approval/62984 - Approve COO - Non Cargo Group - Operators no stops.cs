...
namespace MTNAutomationTests.TestCases.Master_Terminal.General.Ownership_Change_Enquiry.Approval
{
    ...
    public class TestCase62984 : MTNBase
    {
        ...
        void MTNInitialize()
        {
            CallJadeScriptToRun(TestContext, "resetData_62984");
        ...
        public void NonCargoGroupOperatorsNoStops()
        {
            ...
            ownershipChangeEnquiryForm.FindSelectSpecificCOO(new OwnershipChangeSearchArguments { Number = "COO62984" }, "Number^COO62984")
            ...
            cargoEnquiryForm.SearchForCargo(    
               new []
                    { new GetSetFieldsOnFormArguments { FieldName = CargoEnquiryForm.SearchFields.CargoID, FieldValue = "COO62984"}, })
               .ValidateDataTableRowDetails(new [] { "ID^COO62984A01~Opr^COO1~Location ID^MKBS01" })
               ...
               .CheckTransactionsRowDetails(new []
               {
                   ...
                   "Type^Ownership Changed~Details^Change of Ownership - COO62984",
