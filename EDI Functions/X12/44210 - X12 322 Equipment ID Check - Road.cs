...
namespace MTNAutomationTests.TestCases.Master_Terminal.EDI_Functions.X12
{
    ...
    public class TestCase44210 : MTNBase
    {
        ...
        [ClassInitialize]
        public static void ClassInitailze(TestContext testContext) => BaseClassInitialize_New(testContext);
        ...
        public void Road()
        {
            ...
            CallJadeScriptToRun(TestContext, @"resetData_44210");
            ...
            RunAdhocReport(@"02042019", @"0400", @"02042019", @"0500", getTab: true);   // Cargo ID JLG44210013
            RunAdhocReport(@"02042019", @"0500", @"02042019", @"0600");   // Cargo ID JLG4421001
            RunAdhocReport(@"02042019", @"0600", @"02042019", @"0700");   // Cargo ID JLG44210
            RunAdhocReport(@"02042019", @"0700", @"02042019", @"0800");   // Cargo ID JLGF4421001
            ...
            SearchOnCargoEnquiry(@"JLG44210, JLGF442");

            // Cargo ID = JLG44210013
            string[] linesToCheck1 =
            {
                @"Transaction: Released - Road",
                @"N7**JLG4421001*2500*G*400******CN*ALL***02000*A*K**HH***FLTP*ALL*~",
                @"W2**JLG4421001**CN*L***********~"
            };
            ...
            {
                @"Transaction: Released - Road",
                @"N7*JLG*4421001*2500*G*400******CN*ALL***02000*A*K*3*HH***FLTP*ALL*~",
                @"W2*JLG*4421001**CN*L********3***~"
            };
            ...
            ValidateEDIInfoIsCorrect(@"Location ID^MKBS01~ID^JLG44210013~Type^FLTP",
            ...
            ValidateEDIInfoIsCorrect(@"Location ID^MKBS01~ID^JLG4421001~Type^FLTP",
                linesToCheck1, linesToCheck2, linesToCheck3, linesToCheck4);
            ...
            {
                @"Transaction: Released - Road",
                @"N7**JLG44210*2500*G*400******CN*ALL***02000*A*K**HH***TRAI*ALL*~",
                @"W2**JLG44210**CN*L***********~"
            };
            ...
            ValidateEDIInfoIsCorrect(@"Location ID^MKBS01~ID^JLG44210~Type^TRAI",
                linesToCheck1, linesToCheck2, linesToCheck3, linesToCheck4);

            // Cargo ID = JLGF4421001
            linesToCheck1 = new string[]
            {
                @"Transaction: Released - Road",
                @"N7*JLGF*442100*2500*G*400******CN*ALL***02000*A*K*1*HH***2200*ALL*~",
                @"W2*JLGF*442100**CN*L********1***~"
            };
            ...
            ValidateEDIInfoIsCorrect(@"Location ID^MKBS01~ID^JLGF4421001~Type^2200",
                linesToCheck1, linesToCheck2, linesToCheck3, linesToCheck4);
        ...
        private void RunAdhocReport(string startDate, string startTime, string endDate, string endTime, bool getTab = false)
        {
            ...
            _ediCAMProtocolForm.GetScheduledTimesTabAndDetails(findTab: getTab);
        ...
        /*private void SetRelaxedIDChecking(bool newState)
        {
            // Go to Special Protocol Settings and make sure Relaxed ID Checking set to false
            //int value = newState ? 1 : 0;
            _ediCAMProtocolForm.GetSpecialProtocolSettingsTabAndDetails();
            _ediCAMProtocolForm.DoEdit();
            _ediCAMProtocolForm.chkRelaxedIDChecking.DoClick(newState);
            //MTNControlBase.SetValue(_ediCAMProtocolForm.chkRelaxedIDChecking1, value.ToString());
            _ediCAMProtocolForm.DoSave();
        }*/
