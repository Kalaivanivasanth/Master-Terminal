...
namespace MTNAutomationTests.TestCases.Master_Terminal.Yard_Functions.Cargo_Review
{
    ...
    public class TestCase60351 : MTNBase
    {
        ...
        public void ReleaseRequestTrackedByQtyNoReserveDetailsWithCOO()
        {
            ...
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRoad, "60351Road1", ReleaseRequestAddForm.ReleaseType.Road);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestShip, "60251Ship1", ReleaseRequestAddForm.ReleaseType.Ship);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRail, "60351Rail1", ReleaseRequestAddForm.ReleaseType.Rail);
        }
        ...
        void DoReleaseRequestProcess(string menuOptionToSelect, string releaseNo, string releaseType)
        {
            ...
            WarningErrorForm.CheckErrorMessagesExist("Errors for Release Request update TT1",
                new[]
                {
                    $"Code :96296. Item {_cargoGroupId[0]} has 498619.905 MT in current ownership changes, cannot release further 498619.905 MT"
                });
