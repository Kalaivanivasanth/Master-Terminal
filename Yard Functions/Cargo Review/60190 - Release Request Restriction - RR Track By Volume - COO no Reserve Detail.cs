...
namespace MTNAutomationTests.TestCases.Master_Terminal.Yard_Functions.Cargo_Review
{
    ...
    public class TestCase60190 : MTNBase
    {

        readonly string[] _cargoGroupId = { "CG60190C", };
        ...
        public void ReleaseRequestTrackedByQtyNoReserveDetailsWithCOO()
        {
            ...
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRoad, "60190Road1",
                ReleaseRequestAddForm.ReleaseType.Road);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestShip, "60190Ship1",
                ReleaseRequestAddForm.ReleaseType.Ship);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRail, "60190Rail1",
        ...
        void DoReleaseRequestProcess(string menuOptionToSelect, string releaseNo, string releaseType)
        {
            ...
            WarningErrorForm.CheckErrorMessagesExist("Errors for Release Request update TT1",
                new[]
                {
                    $"Code :96296. Item {_cargoGroupId[0]} has 220460.0000 m3 in current ownership changes, cannot release further 220460.0000 m3"
                });
