...
namespace MTNAutomationTests.TestCases.Master_Terminal.General.Ownership_Change_Enquiry
{
    ...
    public class TestCase66004 : MTNBase
    {
        const string MSLDebtor = "RDT";   // Operator MSL's Debtor
        
        const string CargoId = "COO66004A0";
        const string COOId = "COO66004";
        ...
        void MTNInitialize()
        {
            ...
            CallJadeScriptToRun(TestContext, "resetData_66004");
        }

        [TestMethod]
        public void INCOFutureChargeOld()
        {
            MTNInitialize();
            ...
            ownershipChangeMaintForm
                .AddCOO(new OwnershipChangeDetailsAddArguments
                {
                    COOFieldsToSet = new []
                    {
                        ...
                        { FieldRowName = OwnershipChangeMaintForm.ControlFieldName.COONumber, FieldRowValue = $"{COOId}E" },
                        new MTNGeneralArguments.FieldRowNameValueArguments
