...
namespace MTNAutomationTests.TestCases.Master_Terminal.Yard_Functions.Cargo_Review
{
    ...
    public class TestCase60766 : MTNBase
    {
        ...
        public void ReleaseRequestTrackedByQtyNoReserveDetailsWithCOO()
        {
            ...
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRoad, "60766Road2",
                ReleaseRequestAddForm.ReleaseType.Road);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestShip, "60766Ship2",
                ReleaseRequestAddForm.ReleaseType.Ship);
            DoReleaseRequestProcess(CargoReviewForm.QueryResultsContextMenu.CreateReleaseRequestRail, "60766Rail2",
        ...
        void DoReleaseRequestProcess(string menuOptionToSelect, string releaseNo, string releaseType)
        {
            ...
            WarningErrorForm.CheckErrorMessagesExist("Errors for Release Request update TT1",
                new[]
                {
                    $"Code :96294. Item {_cargoGroupId[0]} has 9990.0000 m3 of 699900.0000 m3 already reserved plus 559992.0000 m3 in current ownership changes, cannot release further 689910.0000 m3"
                });
